var data = `[
    ...
    <div class="col-sm-6 col-lg-4 d-flex align-items-stretch">
                <div class="card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mb-3">
                            <span class="badge text-bg-warning">version: ${element.version}</span>
                        </div>
                        <p class="card-text">${element.description}</p>
                        <div class="mb-4">
                            <span class="badge rounded-pill text-bg-success">shortname: ${element.shortname}</span>
                            <span class="badge rounded-pill text-bg-success">arch: ${element.arch}</span>
                            <span class="badge rounded-pill text-bg-success">identifier: ${element.identifier}</span>
                            <span class="badge rounded-pill text-bg-success">release_stage: "${element.release_stage}"</span>
                        </div>
                        <span class="flex-grow-1"></span>
                        <a href="./details.html?id=${element.id}" class="btn btn-success bg-success-subtle text-success-emphasis">Show details</a>
                    </div>
                </div>
            </div>
    `
  ...
  const elementId = document.getElementById("suse-data-container");
